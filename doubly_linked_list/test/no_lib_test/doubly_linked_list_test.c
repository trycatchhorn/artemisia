...
int test_remove_element_tail_doubly_linked_list() {
  ...
  /* get the new tail element */
  new_tail = get_tail_doubly_linked_list( list );

  /* check that the new tail element is correct */
...
int test_remove_all_doubly_linked_list() {
  ...
  if ( NULL != get_element_at_doubly_linked_list( list, 2 ) ) {
    result = -1;
  }
  if ( NULL != get_element_at_doubly_linked_list( list, 3 ) ) {
    result = -1;
  }
  if ( NULL != get_element_at_doubly_linked_list( list, 4 ) ) {
    result = -1;
  }
  if ( NULL != get_head_doubly_linked_list( list ) ) {
    result = -1;
